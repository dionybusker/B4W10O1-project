...
<a class="my-2 btn btn-custom-red rounded-0" href="<?php echo URL ?>users/destroy/<?php echo $users["id"] ?>" onClick="javascript: return confirm('Are you really, really sure?');">Delete!</a>
