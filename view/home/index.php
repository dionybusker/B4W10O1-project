...
if (!isset($_SESSION["user_id"]) && $_SESSION["loggedin"] == true) { ?>
    ...
    <div class="row col-12">
        ...
        <div class="col-6">
            <a class="col-4 btn btn-custom-blue rounded-0" href="<?php echo URL ?>home/login">Log in!</a>
        </div>
    </div>
...
<?php } else { ?>
    ...
    <a class="col-3 my-2 btn btn-custom-blue rounded-0" href="<?php echo URL ?>home/logout">Log out</a>
